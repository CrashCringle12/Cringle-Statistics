...
public class Controller {
    ...
    public void addScrolling() {
        view.getMf().getIp().cp.addMouseWheelListener((MouseWheelEvent e) -> {
    ...
    public void addClicking() {
            for (int i = 1; i < view.getMf().getIp().cp.getBs().size(); i += 9) {
                view.getMf().getIp().cp.getBs().get(i).addActionListener((ActionEvent event) -> {
            ...
            view.getMf().getIp().cp.getHeaders().forEach((i) -> {
                i.addActionListener((ActionEvent event) -> {
                    JButton v = (JButton) event.getSource();
